 ...
 * 获取特定导出记录
 */
router.get('/exports/:exportId', authenticate, async (req, res) => {
    try {
        const userId = getUserId(req);
 ...
 * 下载导出的文件
 */
router.get('/exports/:exportId/download', authenticate, async (req, res) => {
    try {
        const userId = getUserId(req);
        const { exportId } = req.params;
        const service = getMedicalHistoryService();
...
//# sourceMappingURL=medical-history.routes.js.map