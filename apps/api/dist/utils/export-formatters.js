 ...
 * @param options 格式化选项
 */
export async function formatAsPdf(report, filePath, options = {}) {
...
/** 生成PDF内容 */
function generatePdfContent(doc, report, options) {
 ...
 * @param options 格式化选项
 */
export async function formatAsJson(report, filePath, options = {}) {
    const jsonData = {
        ...report,
        // 添加导出元数据
        exportMetadata: {
 ...
 * @param options 格式化选项
 */
export async function formatAsText(report, filePath, options = {}) {
    const lines = [];
...
//# sourceMappingURL=export-formatters.js.map