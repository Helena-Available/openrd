...
export class KnowledgeService {
    ...
    async callPythonBridge(args, input) {
    ...
    async getStats() {
        ...
        try {
            ...
            const statsResult = {
                success: true,
                stats: {
                    totalChunks: result.stats?.total_chunks || 0,
                    languageDistribution: result.stats?.language_distribution || {},
                    categoryDistribution: result.stats?.category_distribution || {},
                    fileTypeDistribution: result.stats?.file_type_distribution || {},
                },
            };
